...
def edit_parcel(request, id):
    ...
    if request.method == 'POST':
        ...
        parcellist.receiver_email = request.POST.get('receiver_email')
...
def edit_parcel2(request, id):
    ...
    if request.method == 'POST':
        parcellist2.post_id = request.POST.get('post_id')
        parcellist2.sendername = request.POST.get('sendername')
        parcellist2.sender_address = request.POST.get('sender_address')
        parcellist2.sender_contact = request.POST.get('sender_contact')
        parcellist2.receivername = request.POST.get('receivername')
        parcellist2.receiver_address = request.POST.get('receiver_address')
        parcellist2.receiver_postoffice = request.POST.get('receiver_postoffice')
        parcellist2.receiver_contact = request.POST.get('receiver_contact')
        parcellist2.receiver_email = request.POST.get('receiver_email')
        parcellist2.posted_date = request.POST.get('posted_date')
        parcellist2.remarks = request.POST.get('remarks')
        parcellist2.weight = request.POST.get('weight')
        parcellist2.kms = request.POST.get('kms')
        parcellist2.price = request.POST.get('price')
        parcellist2.postman_name = request.POST.get('postman_name')
        parcellist2.save()
        return redirect('parcellist2')  
    else:
        parcel=postmodel.objects.all()
